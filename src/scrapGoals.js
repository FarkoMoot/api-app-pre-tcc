...
async function getGoals2(link, time){
  ...
  const recebeGOLS = await page.evaluate(() => {
    return {
      ...
      gol_off_65: document.querySelector('#contentleft > div.half > div.table2.table3.table5 > table > tbody:nth-child(2) > tr:nth-child(1) > td.bold ').textContent,
      over_2_gols: document.querySelector('#contentleft > div.half > div:nth-child(2) > table > tbody > tr:nth-child(1) > td.bold ').textContent,
    }
  }) 
